  ...
  useEffect(() => {
    const loadBalances = async () => {
      if (!connected || !publicKey || !connection) {
        console.log('Skipping balance load - not ready:', {
          connected,
          publicKey: !!publicKey,
  ...
  const handleCreateToken = async () => {
    ...
    const loadingToast = toast.loading(
      parseFloat(buyAmount) > 0
        ? 'Creating and buying in one transaction...'
        : 'Creating token with pump address...'
    );
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-base-content/70 max-w-2xl mx-auto">
              Launch your token on Pump.fun with vanity addresses ending in "pump" - fully
              decentralized and lightning fast
            </p>
          </div>
                ...
                <div className="card-body text-center p-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      {wallet && !connecting && (
                        <button onClick={handleConnect} className="btn btn-outline btn-sm w-full">
                          Manual Connect
                        </button>
                      )}
                      <button
                      ...
                      <div className="alert alert-info mb-6 border border-info/30">
                        ...
                        <div>
                          ...
                          <div className="text-sm mt-1">
                            {pumpAddressStats.pool_size} addresses ending in "pump" available. Fully
                            decentralized with direct Pump.fun integration.
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="form-control mb-4">
                        ...
                        <div className="label">
                          <span className="label-text-alt text-base-content/60">
                            Buy tokens immediately after creation
                          </span>
                        </div>
                      </div>
                      ...
                      {!createdTokenMint ? (
                        <div className="text-center py-12">
                          ...
                          <p className="text-base-content/70">
                            Create your token first to start trading
                          </p>
                        </div>
                      ) : (
                              ...
                              <div className="alert alert-info">
                                ...
                                <div>
                                  <div className="text-sm">
                                    As the token creator, you earn fees from all trading activity.
                                  </div>
